...
export interface Me {
  ...
  pertenencias: Array<{ id: string; nombre: string; slug: string; estado: string }>
  roles: string[]
  permisos: string[]
}
...
export const useAuthStore = defineStore('auth', () => {
  ...
  const permisos = computed<string[]>(() => me.value?.permisos ?? [])
  ...
  // Se ejecuta una vez para detectar una sesión de cookie ya existente.
